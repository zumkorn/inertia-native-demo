...
export default function ResourceLong() {
  return (
    <>
      <Head title="A Really Long Page" />

      <div className="top-level-container">
        <h1 className="hide@native margin-bs-xl text-large-title">A Really Long Page</h1>

        <p>Scroll down a bit, then tap a link to navigate forward to another screen.</p>
        ...
        <p><a href="#bottom">Scroll to the bottom of the screen</a></p>

        <p>There now is your insular city of the Manhattoes, belted round by wharves as Indian isles by coral reefs—commerce surrounds it with her surf.</p>

        <p><Link href="/resources/scroll">Navigate to another screen</Link></p>

        <p>Right and left, the streets take you waterward. Its extreme downtown is the battery, where that noble mole is washed by waves, and cooled by breezes, which a few hours previous were out of sight of land. Look at the crowds of water-gazers there.</p>
        ...
        <p id="bottom"><Link href="/resources/scroll">Navigate to another screen</Link></p>
